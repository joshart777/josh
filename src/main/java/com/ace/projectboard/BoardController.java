...
public class BoardController {
	...
	public String ftpproject1_tab01(ModelMap model, BoardVO vo, Criteria cri) throws Exception {
	...
	public String board_write(ModelMap model, BoardVO vo) throws Exception {
	...
	public String board_insert(ModelMap model, BoardVO vo) throws Exception {
	...
	public String board_delete(ModelMap model, BoardVO vo) throws Exception{
